...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@400;700&family=Montserrat:wght@300;400;600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // form switch - toggles row direction to swap brand and form positions
            $('a.switch').click(function (e) {
                e.preventDefault();
                $('.row').toggleClass('signup-active');
            });
